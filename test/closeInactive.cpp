/*************************************************************************
	> File Name: closeInactive.cpp
	> Author: 
	> Mail: 
	> Created Time: 2017年02月22日 星期三 09时33分20秒
 ************************************************************************/
...
void timer_handler()
{
    ...
    //因为一次alarm调用只会引起一次SIGALRM信号，所以我们要重新定时，以不断
    //触发SIGALRM信号
    alarm(TIMESLOT);
}

//定时回调函数，它删除非活动连接socket上的注册时间，并关闭之
